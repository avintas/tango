...
export default function PromptGeneratorPage() {
  ...
  const fetchVariables = async () => {
    ...
    try {
      const response = await fetch('/api/prompt-variables?type=motivational', {
        headers: {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await fetch('/api/gemini/motivational-generate', {
        method: 'POST',
        headers: {
    ...
    <div className="space-y-6">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="mt-2 text-gray-600 dark:text-gray-400">
          Generate motivational and inspirational hockey content
        </p>
      </div>
