...
export default function PromptGeneratorPage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await fetch('/api/gemini/stats-generate', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="space-y-6">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900">Stats Generator</h1>
        <p className="mt-2 text-gray-600 dark:text-gray-400">
          Generate hockey statistics and data-driven content
        </p>
      </div>
